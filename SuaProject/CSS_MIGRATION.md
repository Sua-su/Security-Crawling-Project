...
3. **Modules** 탭에서 Path 확인: `/SuaProject`
...
4. 다음 파일들이 200 OK로 로드되는지 확인:
   ```
   /SuaProject/assets/css/common.css
   /SuaProject/assets/css/auth.css (로그인 페이지)
   /SuaProject/assets/css/board.css (게시판 페이지)
   /SuaProject/assets/css/shop.css (쇼핑몰 페이지)
   /SuaProject/assets/css/admin.css (관리자 페이지)
   /SuaProject/assets/css/mypage.css (마이페이지)
   ```
