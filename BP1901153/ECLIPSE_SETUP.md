...
```bash
# 프로젝트 디렉토리로 이동
cd /Users/su/Documents/Security-Crawling-Project-test/BP1901153
...
- 로그인: http://localhost:8080/BP1901153/auth/login.jsp
- 회원가입: http://localhost:8080/BP1901153/auth/signup.jsp
- 게시판: http://localhost:8080/BP1901153/board/list.jsp
- 쇼핑몰: http://localhost:8080/BP1901153/shop/products.jsp
- 관리자: http://localhost:8080/BP1901153/admin/dashboard.jsp
